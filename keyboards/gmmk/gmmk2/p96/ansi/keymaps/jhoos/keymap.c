...
[_BLW] = LAYOUT(
  ...
  KC_LCTL,  KC_LGUI,  KC_LALT,                      KC_SPC,                                 KC_RALT,  MO(_FLW), KC_RCTL,  KC_LEFT,  KC_DOWN,  KC_RGHT,  KC_P0,    KC_PDOT),
...
[_NLM] = LAYOUT(
  ...
  /* Keymap _ALTW: Remap left alt to contrl (Windows)
   */
[_ALTW] = LAYOUT(
  _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,
  _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,
  ...
  _______,  _______,  TD_LALT,                      _______,                                _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______),
...
[_FLW] = LAYOUT(
  ...
  _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,             _______,  _______,  _______,
  _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,             _______,  _______,  _______,  _______,
  _______,  DF(_BLM), TG(_ALTW),                    _______,                                _______,  _______,  _______,  _______,   _______,  _______,  _______,  _______),
